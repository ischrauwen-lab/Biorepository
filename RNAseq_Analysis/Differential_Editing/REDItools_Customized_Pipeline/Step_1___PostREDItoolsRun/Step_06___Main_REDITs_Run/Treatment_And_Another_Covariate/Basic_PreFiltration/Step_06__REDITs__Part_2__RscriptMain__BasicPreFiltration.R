...
REDITs_Cloned_Directory <- "/path/to/cloned/github/REDITs"

### Read the data from the basic filtered TSV file (Step 4 Part 5 tsv file)
data_file <- "/path/to/Step_04___FilterationViaProportion___BasicPreFiltration/Part_5___MergingPivotedTables_BasicPreFiltered_REDITsInput/Output_File.tsv"
